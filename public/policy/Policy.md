...
- Nội dung tin đăng phải **chính xác, rõ ràng, không vi phạm pháp luật**.
- Không được đăng các mặt hàng **cấm** như: ma túy, vũ khí, động vật hoang dã, hàng giả, hàng nhái...
- Tin đăng **phải có hình ảnh thật** của sản phẩm, không sử dụng ảnh minh họa tràn lan.
- Một sản phẩm chỉ được đăng **một lần duy nhất**, không đăng trùng lặp gây spam.

---

## 3. Quy định về giao dịch
...
- Tin vi phạm sẽ bị **ẩn/bỏ duyệt mà không cần báo trước**.
- Người dùng đăng tin sai phạm nhiều lần sẽ bị **khóa tài khoản vĩnh viễn**.
- Chúng tôi có quyền **cung cấp thông tin** người dùng cho cơ quan chức năng nếu có yêu cầu pháp lý.
...
Chúng tôi có thể cập nhật chính sách này theo thời gian nhằm phù hợp với thay đổi pháp lý và định hướng hoạt động. Bạn nên **kiểm tra định kỳ** để đảm bảo luôn nắm rõ quyền lợi và nghĩa vụ của mình.
