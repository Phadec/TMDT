          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="mt-1 text-xs text-gray-500">
                Tối thiểu 10 ký tự, tối đa 50 ký tự. Chỉ chữ, số và khoảng
                trắng.
              </div>
              {productNameError && (
            ...
            <div>
              <label className="block mb-1 text-sm font-medium text-gray-700">
                ...
                <span className="ml-1 text-xs text-gray-500">
                  (Tối đa 4 thẻ, mỗi thẻ không quá 20 ký tự)
                </span>
              </label>
              <div className="relative">
                <input
            ...
            <div>
              ...
              {!addressValid && (
                <p className="mt-1 text-xs text-red-500">
                  Địa chỉ không hợp lệ hoặc không tìm thấy.
                </p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="mt-1 text-xs text-gray-500">Tối đa 1000 từ.</div>
              {descriptionError && (
                <p className="mt-1 text-xs text-red-500">{descriptionError}</p>
              )}
              <div className="mt-1 text-xs text-right text-gray-500">
                {description.trim().split(/\s+/).filter(Boolean).length} / 1000
                từ
              </div>
            </div>
          </div>
            ...
            onClick={async () => {
              ...
              if (images.length < 10) {
                Swal.fire({
                  icon: "warning",
                  title: "Chưa đủ ảnh",
                  text: `Cần ít nhất 10 ảnh sản phẩm để đăng bán. Bạn còn thiếu ${
                    10 - images.length
                  } ảnh.`,
                  confirmButtonColor: "#3B82F6",
