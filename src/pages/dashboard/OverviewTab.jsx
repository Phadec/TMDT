...
export const ActivityItem = ({ item }) => {
  return (
    <div
      key={item}
      className="flex flex-wrap sm:flex-nowrap items-start gap-4 pb-4 border-b border-gray-100"
    >
      ...
      <div className="text-sm font-medium text-emerald-500 mt-2 sm:mt-0 w-full sm:w-auto sm:text-right">
