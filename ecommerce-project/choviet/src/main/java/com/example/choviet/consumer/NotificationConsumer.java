...
public class NotificationConsumer {
    ...
    public void handleLoginEvent(Event<UserDto> event) {
        try {
    ...
    public void handleRegisterEvent(Event<UserDto> event) {
        try {
    ...
    public void handleLogoutEvent(Event<UserDto> event) {
        try {
    ...
    public void handleChangePasswordEvent(Event<UserDto> event) {
        try {
    ...
    public void handleVerifyEmailEvent(Event<UserDto> event) {
        try {
